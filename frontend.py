from tkinter import Tk, Label, Button, Entry, END, Listbox, Scrollbar, StringVar
...
window.wm_title("Bibliotecă digitală")
...
l3=Label(window,text="An apariție")
...
b2.grid(row=3,column=3, sticky=N+S+E+W)
...
b7=Button(window,text="Clear text", width=12,command=clear_label)
